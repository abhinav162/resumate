...
import { ResumeBuilder, resumeClsContent, type ResumeBuilderConfig } from '../lib/latex';
 ...
 */
export const generateTexString = (resumeData: ResumeData, config?: ResumeBuilderConfig): string => {
