...
import { generateDocumentTemplate, TemplateConfig } from './templates';
import { 
    HeaderGenerator, 
    SkillsGenerator, 
    SummaryGenerator, 
...
export class ResumeBuilder {
    ...
    constructor(private config: ResumeBuilderConfig = {}) {
    ...
    private generateAllSections(resumeData: ResumeData): Record<string, string> {
        const { skills, summary, experience, projects, education } = resumeData;
